-- ---------------------------------------------------------------------
-- ApoyaClub: correo de contacto propio del club (migracion 0024).
--
-- Añade un correo de contacto que el club puede publicar en vez del de
-- la cuenta con la que se registro. Si se deja vacio, se sigue usando el
-- de la cuenta.
--
