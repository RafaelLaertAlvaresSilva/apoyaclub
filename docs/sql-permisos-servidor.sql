-- ---------------------------------------------------------------------
-- ApoyaClub: permisos del servidor (migracion 0028).
--
-- Arregla que las metricas del club salgan siempre a cero: la cuenta con
-- la que trabaja el servidor no tenia permiso para apuntar las visitas
-- ni para leer los contadores, y el codigo se tragaba el error.
--
-- NO borra nada.
