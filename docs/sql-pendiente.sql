-- ---------------------------------------------------------------------
-- ApoyaClub: lo que falta por aplicar (migraciones 0018 a 0022).
--
-- Para una base de datos que ya tiene aplicadas las migraciones 0001 a
-- 0017. Anade:
--
--   0018  el mes gratis empieza al crear el club, sin pasar por Stripe
--   0019  patrocinadores actuales con categoria, texto y orden
--   0020  la ficha completa da visibilidad en el buscador
--   0021  tres planes de precio y las 50 plazas de fundador
--   0022  quien mira cada ficha y quien abre los datos de contacto
--
