...
const ES_NECESIDAD = true;
const TITULO = "Lo que necesitamos";
  ...
  return (
    <div className="flex flex-1 flex-col bg-zinc-50">
      ...
      <div className="mx-auto w-full max-w-4xl flex-1 px-4 sm:px-6 py-6">
        ...
        <p className="mt-2 max-w-2xl text-zinc-600">Servicios y productos que le hacen falta al club. A cambio, la misma visibilidad que cualquier patrocinador.</p>
