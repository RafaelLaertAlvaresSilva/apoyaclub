 ...
 * le iban a cobrar.
 *
 * Así que la portada ahora hace una sola cosa: decir qué es esto y
 * preguntar cuál de los dos eres. El detalle entero vive en
 * `/para-clubes` y `/para-empresas`, que es donde cada uno encuentra
 * todo lo suyo sin tener que saltarse lo del otro.
 *
 * Lo que queda debajo de las dos tarjetas —cómo funciona, precio,
 * preguntas— es la versión corta, para quien no quiere entrar en
 * ninguna de las dos y solo quiere hacerse una idea antes de decidir.
 */
        ...
        <section className="relative overflow-hidden border-b border-zinc-200 bg-gradient-to-b from-zinc-50 to-white px-4 pb-16 pt-10 sm:px-6 sm:pb-20 sm:pt-16">
          ...
          <div className="relative mx-auto max-w-3xl text-center">
            ...
            {/* El titular en dos alturas: la frase que define ApoyaClub
                ...
                un escalón: a 30 px ocupaba ocho líneas y los botones se
                quedaban fuera de la primera pantalla. */}
          ...
          <div id="para-quien" className="relative mx-auto mt-12 grid max-w-5xl scroll-mt-32 gap-5 lg:grid-cols-2">
            <div className="flex flex-col rounded-3xl bg-gradient-to-br from-brand-navy to-brand-navy-dark p-8 text-white shadow-xl shadow-brand-navy/20 sm:p-10">
              ...
              <h2 className="mt-3 text-2xl font-extrabold sm:text-3xl">{t("caminos.clubTitulo")}</h2>
